        ...
        <AlertDialogHeader className="relative z-10">
          <AlertDialogTitle>
            <div className="text-center pt-6 sm:pt-8 pb-4 sm:pb-6 px-4 sm:px-8 border-b border-gray-200/50">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-black tracking-tight mb-2">For Brands</h2>
              <p className="text-base sm:text-lg text-gray-600">Questions about brand partnerships</p>
            </div>
          </AlertDialogTitle>
        </AlertDialogHeader>
