...
import Faq from "@/components/unauthorized/landing-page/faq/faq.component";
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className={`text-xl sm:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed ${heroTriggered ? 'animate-fade-in-up animation-delay-200' : ''}`}>
              Find answers to common questions about COVO and how our platform connects brands with influencers
            </p>
          </div>
        </div>
      </section>
