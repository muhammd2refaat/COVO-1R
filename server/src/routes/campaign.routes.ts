...
campaignRoute.post(
  "/:brandId/campaign/:id/invite",
  authMiddleware,
  campaignController.inviteToCampaign
);
...
campaignRoute.get(
  "/:influencerId/campaigns/invitations", // New route
  authMiddleware,
  campaignController.getCampaignInvitations
);

// New routes for accepting/rejecting invitations
campaignRoute.put(
  "/:influencerId/campaign/:campaignId/brand/:brandId/invitations/accept",
  authMiddleware,
  campaignController.acceptCampaignInvitation
);

campaignRoute.put(
  "/:influencerId/campaign/:campaignId/brand/:brandId/invitations/reject",
  authMiddleware,
  campaignController.rejectCampaignInvitation
);
